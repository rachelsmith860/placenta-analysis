...
if output:
    ...
    #cmgui files
    pg.export_ex_coords(geom['nodes'],'vessels','mouse_tree','exnode')
    pg.export_exelem_1d(geom['elems'],'vessels','mouse_tree')
    export_solution_2(orders['strahler'], 'solution', 'mouse_solution','orders')
    export_solution_2(radii_unscaled, 'radii', 'mouse_radii','radius')
    export_solution_2(orders['generation'], 'generations', 'mouse_generations', 'gen')
